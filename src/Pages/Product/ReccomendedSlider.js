        ...
        <CustomContainer maxWidth='md'>
            <CustomRow>
                <CustomBox className={classes.sliderHeadMain}>
                    <SectionMainHead>Recommended</SectionMainHead>
                    <CustomNavigation prevClass="bestPrev1" nextClass="bestNext1" className={classes.recoSliderNav} />
                </CustomBox>
                <CustomSwiper
                    slidesPerView={4} 
                    spaceBetween={32} 
...
export default ReccomendedSlider
